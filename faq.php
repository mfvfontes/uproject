                ...
                <div class="col-sm-12">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading" id="subsubtitle">O que é a U.Project?</h4>
                            <p>A U.Project é uma organização que tem por objetivo o desenvolvimento de projetos a nível empresarial que nos são propostos.</p>
                        </div>
                    </div>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading" id="subsubtitle">Se eu tiver alguma sugestão ou dificuldade, como posso contactar-vos?</h4>
                            <p>
							Se nos quiser comunicar algo, pode dirigir-se à página dos Contatos, onde terá um formulário de envio a partir do qual nos pode contatar
							diretamente.
							</p>
                        </div>
                    </div>
